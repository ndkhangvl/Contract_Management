                ...
                <a href="/hopdong/{{$hopdongso}}"><b><i class="bi bi-arrow-return-left"></i>Hợp đồng {{$hopdongso}}</a></b>
                        <div class="bodyfake">
                                ...
                                <form action="/hoadon" method="post" enctype="multipart/form-data" id="hoaDonForm">
                                        ...
                                        <button class="btn btn-primary" onclick="addRowCreate()" type="button">Thêm hàng</button>
                                        ...
                                        <table id='tablechitiet' class='contentcenter'>
                                                ...
                                                <tr>
                                                        ...
                                                        <td><button type="button" name="btnxoa{{$i}}" id="btnxoa{{$i}}" class="btn btn-danger" onclick="delRowCreate(this.id.replace('btnxoa',''))">Xóa</button></td>
                                                </tr>
                                                @endfor
                                        </table>
                                        </div>
...
<script>
        function calHoaDonCreate() {
                ...
                to_VNese_currency_Create();
        }
        document.getElementById("thuesuat").addEventListener('input', calHoaDonCreate);
        ...
        for (var i = 0; i < soluongs.length; i++) {
                soluongs[i].addEventListener('input', calHoaDonCreate);
                dongias[i].addEventListener('input', calHoaDonCreate);
        }
        function addRowCreate(){
                ...
                $soluong.addEventListener('input', calHoaDonCreate);
                ...
                $dongia.addEventListener('input', calHoaDonCreate);
                ...
                $xoa.setAttribute('onclick', 'delRowCreate(this.id.replace("btnxoa",""))');
        ...
        document.getElementById("inputsohoadon").addEventListener('input', checkSHDExistsCreate);
        ...
        function to_VNese_currency_Create() {
