        ...
        <div class="container-fluid">
            <div class="">
                <div class="">
                    <div class="mt-2">
                        <div class="row align-items-center">
                            ...
                            <div class="contentcenter">
                                <h2 style="text-transform: uppercase; font-size: 24px;">Hóa Đơn Dịch Vụ</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="contentright">Số: <b style="padding-right:20px; color:red;">{{ $hoadon->HOADON_SO }}</b></div>
                </div>
                <div class="contentcenter">
            ...
            <div class="">
                ...
                <table class="table table-bordered mt-4">
                    ...
                    <tbody>
                        ...
                        @endforeach
                        <tr>
                            <td colspan="6" class="contentcenter">
                                -------------------------------------------------------</td>
                        </tr>
                        <tr>
