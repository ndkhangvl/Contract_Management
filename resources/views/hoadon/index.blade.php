        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form action="/createHoaDonModal" method="POST" enctype="multipart/form-data" id="hoaDonForm">
                        @csrf
                        
                        Hợp đồng số: 
                        <input class="form-control" type="text" name="sohopdong" id="sohopdong"  value="" readonly>
