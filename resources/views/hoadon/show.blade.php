                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <form action="/updateHoaDonModal/{{ $hoadon->HOADON_ID }}" method="post" enctype="multipart/form-data" id="updateHoaDonForm">
                                @csrf
                                @method('PUT')
                                ...
                                <table id='tablechitiet'>
                                        ...
                                        <tr>
                                                ...
                                                <td><input type="number" class="thanhtien" name="thanhtien{{$cthd->STT}}" readonly id="thanhtien{{$cthd->STT}}" value="{{$cthd->THANHTIEN}}"></td>
                        ...
                        <table class="table mt-4 info-border border-0">
                            <tbody>
                                <tr class="notprint">
                                    ...
                                    <td class="info-td col-8"><b><a href="{{asset('storage/'.$hoadon->HOADON_FILE)}}" target="_blank">{{$hoadon->HOADON_FILE}}</a></b></td>
                                </tr>
                                <tr>
