@foreach ($hopdongs as $hopdong)
    <tr>
        ...
        <td class="w-auto text-truncate"><span data-format="number">{{ $hopdong->HOPDONG_TONGGIATRI }}</span> VNĐ</td>
        ...
        <td class="w-auto">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <form id="deleteForm-{{ $hopdong->HOPDONG_ID }}" action="/hopdong/delete/{{ $hopdong->HOPDONG_ID }}"
                    method="POST">
                    @method('DELETE')
                    @csrf
