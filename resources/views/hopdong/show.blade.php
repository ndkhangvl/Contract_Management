...
<div id="main">
    <div class="container bg-white shadow">
                            ...
                            <form action="/createHoaDonModal" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row mb-3 mt-3">
                                    <div class="col">
                                        ...
                                        <input class="form-control" type="text" name="sohopdong" id="sohopdong" value="{{ $hopdong->HOPDONG_SO }}"
                                            readonly>
                                ...
                                <input class="form-control" type="number" name="soluongchitiet" value="" min="0"
                                    id="slct" required readonly>
                                <hr>
                                ...
                                <div class="mb-3 mt-3 pb-2 text-center">
                                    ...
                                    <button type="submit" id="btnsubmithd"
                                        class="btn btn-success btn-block mb-3 mt-3"><i class="fas fa-plus me-2"></i>Thêm
                                        mới</button>
                                </div>
                            </form>
                        </div>
            ...
            <div class="border" style="padding-left:100px; padding-right:100px">
                <div class="mt-2">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <img src="https://itvnpt.vn/wp-content/uploads/2021/11/Logo-VNPT-TP-HCM-1.png" alt="logo"
                                width="100" height="43.25">
                        </div>
        ...
        <button type="button" class="btn btn-info btn-icon-only" aria-label="Sửa" data-bs-toggle="modal"
